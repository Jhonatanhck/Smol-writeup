...
![Escaneo de puertos con Nmap](images/Pasted image 20260102191827.png)
...
![Edición de /etc/hosts](images/Pasted image 20260102191945.png)

Una vez configurado, podemos acceder a la página web:
![Página web principal](images/Pasted image 20260102192008.png)

Utilizando **Wappalyzer**, confirmamos que hay un **WordPress** corriendo en el servidor.
![Wappalyzer detectando WordPress](images/Pasted image 20260102192343.png)
...
![Resultado de WPScan](images/Pasted image 20260102192612.png)
...
![Archivo vulnerable](images/Pasted image 20260102193146.png)
...
![Explotación LFI para leer config](images/Pasted image 20260102193917.png)

Efectivamente, logramos leer el archivo y obtener las credenciales de la base de datos.
![Credenciales encontradas](images/Pasted image 20260102194001.png)

Con estas credenciales, logramos iniciar sesión en el panel `wp-admin`.
![Dashboard de WordPress](images/Pasted image 20260102194105.png)

Dentro del dashboard, encontré una pista que sugiere que hay una vulnerabilidad en el plugin **Hello Dolly**.
![Pista sobre Hello Dolly](images/Pasted image 20260102194503.png)
...
![Código base64 en plugin](images/Pasted image 20260102194926.png)

Al decodificarla, vemos que básicamente nos permite ejecutar comandos en el sistema.
![Decodificación de la cadena](images/Pasted image 20260102195028.png)
...
![Confirmación de RCE](images/Pasted image 20260102195143.png)
...
![Payload Reverse Shell](images/Pasted image 20260102200311.png)

Nos ponemos en escucha con Netcat en nuestra máquina atacante:
![Netcat escuchando](images/Pasted image 20260102195323.png)

Ejecutamos el payload y ya estamos dentro del sistema.
![Acceso obtenido](images/Pasted image 20260102200349.png)

## 4. Movimiento Lateral

Dentro del directorio `/home` observamos que existen varios usuarios.
![Usuarios en /home](images/Pasted image 20260102200539.png)
...
![Acceso a MySQL](images/Pasted image 20260102201245.png)

Aquí extraje los hashes de las contraseñas de los usuarios.
![Hashes de usuarios](images/Pasted image 20260102201459.png)

Guardé los usuarios en un archivo con el formato adecuado para crackearlos con **John the Ripper**.
![Formato para John](images/Pasted image 20260102202124.png)

John encontró la contraseña para el usuario **diego**, así que la voy a probar inmediatamente.
![John crackeando password](images/Pasted image 20260102202446.png)

Logramos acceder como el usuario diego.
![Login como diego](images/Pasted image 20260102202526.png)
...
![Directorio .ssh de think](images/Pasted image 20260102203405.png)

Efectivamente, aquí tenemos el `id_rsa`.
![Clave privada RSA](images/Pasted image 20260102203456.png)

Usamos la clave para conectarnos y ya estamos dentro como **think**.
![Login como think](images/Pasted image 20260102203558.png)

### Usuario Gege

Revisando una ruta que vi en el output de LinPEAS, parece que hay una regla de seguridad escrita.
![Ruta sospechosa](images/Pasted image 20260102205842.png)
...
![Regla de permisos](images/Pasted image 20260102210010.png)

Ejecutando `su - gege` pude transformarme en el usuario **gege**.
![Login como gege](images/Pasted image 20260102205412.png)
...
![Transferencia de archivo](images/Pasted image 20260102210116.png)

Voy a intentar usar `zip2john` para obtener el hash y ver si puedo descifrar la contraseña del ZIP.
![Ejecución de zip2john](images/Pasted image 20260102210333.png)

John nos acaba de dar la contraseña para el archivo.
![Password del zip crackeada](images/Pasted image 20260102210637.png)

Descomprimo el archivo y reviso el directorio resultante.
![Directorio descomprimido](images/Pasted image 20260102210801.png)

En este archivo encontramos las credenciales para convertirnos en el usuario **xavi**.
![Credenciales de xavi](images/Pasted image 20260102211241.png)

Ya estamos dentro como **xavi**.
![Login como xavi](images/Pasted image 20260102211325.png)

Estando como xavi, reviso mis permisos (`sudo -l`) y me fijo que puedo ejecutar cualquier comando como root.
![Permisos sudo](images/Pasted image 20260102211405.png)

Ahora, al ejecutar `sudo su` (o el comando permitido), nos transformaremos en root.
![Escalada a root](images/Pasted image 20260102211458.png)

Y ya somos **root**. PWNED!
![Root access](images/Pasted image 20260102211525.png)

Aquí está la flag:
![Root Flag](images/Pasted image 20260102211624.png)
